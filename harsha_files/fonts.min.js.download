...
permissions:"all",fallbacks:"",spriteIndex:213},"brandon-grot-w01-light":{displayName:"Brandon Grotesque",fontFamily:"brandon-grot-w01-light",cdnName:"",genericFamily:"sans-serif",provider:"monotype",characterSets:["latin"],permissions:"all",fallbacks:"",spriteIndex:214},"avenir-lt-w01_85-heavy1475544":{displayName:"Avenir",fontFamily:"avenir-lt-w01_85-heavy1475544",cdnName:"",genericFamily:"sans-serif",provider:"monotype",characterSets:["latin"],permissions:"all",fallbacks:"",spriteIndex:215},"avenir-lt-w01_35-light1475496":{displayName:"Avenir Light",fontFamily:"avenir-lt-w01_35-light1475496",cdnName:"",genericFamily:"sans-serif",provider:"monotype",characterSets:["latin"],permissions:"all",fallbacks:"",spriteIndex:216},"didot-w01-italic":{displayName:"Linotype Didot",fontFamily:"didot-w01-italic",cdnName:"",genericFamily:"serif",provider:"monotype",characterSets:["latin"],permissions:"all",fallbacks:"",spriteIndex:217},"adobe-caslon-w01-smbd":{displayName:"Adobe Caslon",fontFamily:"adobe-caslon-w01-smbd",cdnName:"",genericFamily:"serif",provider:"monotype",characterSets:["latin"],permissions:"all",fallbacks:"",spriteIndex:218},"kepler-w03-light-scd-cp":{displayName:"Kepler",fontFamily:"kepler-w03-light-scd-cp",cdnName:"",genericFamily:"serif",provider:"monotype",characterSets:["latin"],permissions:"all",fallbacks:"",spriteIndex:219},"baskervillemtw01-smbdit":{displayName:"Monotype Baskerville",fontFamily:"baskervillemtw01-smbdit",cdnName:"",genericFamily:"serif",provider:"monotype",characterSets:["latin"],permissions:"all",fallbacks:"",spriteIndex:220},"belinda-w00-regular":{displayName:"Belinda",fontFamily:"belinda-w00-regular",cdnName:"",genericFamily:"script",provider:"monotype",characterSets:["latin"],permissions:"all",fallbacks:"",spriteIndex:221},"helveticaneuew01-55roma":{displayName:"Helvetica 55",fontFamily:"helveticaneuew01-55roma",cdnName:"",genericFamily:"sans-serif",provider:"monotype",characterSets:["latin"],permissions:"studio",fallbacks:"",spriteIndex:222},"peaches-and-cream-regular-w00":{displayName:"Peaches & Cream",fontFamily:"peaches-and-cream-regular-w00",cdnName:"",genericFamily:"script",provider:"monotype",characterSets:["latin"],permissions:"all",fallbacks:"",spriteIndex:223},"dinneuzeitgroteskltw01-_812426":{displayName:"DIN Neuzeit Grotesk",fontFamily:"dinneuzeitgroteskltw01-_812426",cdnName:"",genericFamily:"sans-serif",provider:"monotype",characterSets:["latin"],permissions:"all",fallbacks:"",spriteIndex:224}};if(c){a.merge(d,{"bad script":{displayName:"Bad Script",fontFamily:"bad script",cdnName:"Bad+Script",genericFamily:"cursive",provider:"google",characterSets:["cyrillic"],permissions:"all",fallbacks:"",spriteIndex:225},roboto:{displayName:"Roboto",fontFamily:"roboto",cdnName:"Roboto",genericFamily:"sans-serif",provider:"google",characterSets:["cyrillic"],permissions:"all",fallbacks:"",spriteIndex:226},underdog:{displayName:"Underdog",fontFamily:"underdog",cdnName:"Underdog",genericFamily:"cursive",provider:"google",characterSets:["cyrillic"],permissions:"all",fallbacks:"",spriteIndex:227},"poiret one":{displayName:"Poiret One",fontFamily:"poiret one",cdnName:"Poiret+One",genericFamily:"cursive",provider:"google",characterSets:["cyrillic"],permissions:"all",fallbacks:"",spriteIndex:228},"playfair display cyrillic":{displayName:"Playfair Display",fontFamily:"playfair display",cdnName:"Playfair+Display",genericFamily:"serif",provider:"google",characterSets:["cyrillic"],permissions:"all",fallbacks:"",spriteIndex:229}})}return d});define("fonts/utils/fontUtils",["lodash","fonts/utils/fontMetadata","utils","experiment"],function(a,b,c,d){"use strict";var e="//fonts.googleapis.com/css?family=";var f=["latin-ext","cyrillic","japanese","korean","arabic","hebrew","latin"];var g=/<[^>]+class="[^"]*(font_[0-9]+)[^"]*"/g;var h={StyledText:function(a,b){return[b.text]},RichText:function(a,b){return[b.text]}};function i(a,b){h[a]=b}var j={};function k(a,b){j[a]=b}function l(a){return c.cssUtils.parseFontStr(a)}function m(a){return a.split(" ")[4]}function n(c){return a.compact(a.map(c,function(a){return b[a]}))}function o(a){var c=a.replace(/\+/g," ").toLowerCase();var d=b[c];if(d){var e=d.fallbacks;if(e){e+=","}e+=d.genericFamily;return e}return""}function p(b){return a(b).split(",").invoke("replace",/.*[^\w\d\-].*/,'"$&"').join(",")}function q(a){var c=b[a.toLowerCase()];var d=c.fontFamily,e;if(c){e=d;if(c.fallbacks!==""){e+=","+c.fallbacks}e+=","+c.genericFamily}else{e=a}return p(e)}function r(b,c){if(b.length===0){return undefined}var d=a.map(b,function(a){return a.cdnName+":n,b,i,bi|"});if(c){d.push("&subset=");d.push(c.join(","))}return e+d.join("")}function s(c,d){var e=a.filter(t(c,d),function(c){return a.has(b,c)});return n(e)}function t(a,b){return v(a,b)}function u(b){var c=a.times(11,function(a){return"font_"+a});return w(b,c)}function v(b,d){var e=b.getPageData(d).data.document_data;var f=a(e).filter(function(b){return a.has(h,b.type)}).map(function(d){var e=h[d.type](b,d);return a.union(c.fonts.fontsParser.collectFontsFromTextDataArray(e))}).flattenDeep().value();var g=a(e).filter(function(b){return a.has(j,b.type)}).map(function(a){return j[a.type](b,a)||[]}).flattenDeep().value();var i=a.get(e,"masterPage.usedFonts",[]);return a.union(f,g,u(b),i)}function w(b,c){var d=b.getGeneralTheme();return a.map(c,function(a){return x(d,a)})}function x(a,b){var c=a.font;var d=parseInt(b.substring(b.indexOf("_")+1),10);var e=c[d];var f="";if(e){f=l(e).family.toLowerCase()}return f}function y(a){var c=b[a.toLowerCase()];var d=c&&c.fontFamily,e;if(c){e=d;if(c.fallbacks!==""){e+=","+c.fallbacks}e+=","+c.genericFamily}else{e=a}return p(e)}function z(b,c,d){if(d&&/localhost|127.0.0.\d/.test(b)){b=d}b=b.replace(/^http:/,"");var e=b.replace(/\/$/,"")+"/static/css/user-site-fonts/";return a.map(c,function(a){return e+a+".css"})}function A(a){return z(a.santaBase,a.getDataByQuery("masterPage").characterSets,a.serviceTopology.scriptsLocationMap.santa)}function B(b,c){var d=D(b);return a(f).intersection(c).map(function(a){return{lang:a,fonts:d[a]}}).value()}function C(a){return B(a.rendererModel.siteInfo.documentType,a.getDataByQuery("masterPage").characterSets)}function D(c){var d=G(c);var e=a.reduce(b,function(b,c,e){var f=c.characterSets;if(a.includes(d,c.permissions)){c.cssFontFamily=q(e);a.forEach(f,function(a){if(!b[a]){b[a]=[]}b[a].push(c)},this)}return b},{});a.forOwn(e,function(b,c){e[c]=a.sortBy(b,"displayName")},this);return e}function E(b,c,d){var f=a.isArray(b)?b:a.keys(b);var g=H(f,c,d);if(g){return e+g}return""}function F(a,b){return E(a,b.rendererModel.siteInfo.documentType,b.getDataByQuery("masterPage").characterSets)}function G(a){var b=["all","legacy"];if(a==="WixSite"){b.push("studio")}return b}function H(c,d,e){var f="";var g=G(d);a.forEach(c,function(c){var d=b[c];if(d&&d.cdnName&&a.includes(g,d.permissions)){f+=d.cdnName;f+=":n,b,i,bi|"}});if(f===""){return null}if(e){f+="&subset="+e.join(",")}return f}function I(a){g.lastIndex=0;var b=g.exec(a);return b?b[1]:undefined}function J(a,b,c){if(b[a]){var d=L(b[a]);return K(d,c)}return L(a)}function K(a,b){var c=a.color&&a.color.match(/{([^}]+)}/);if(b&&c&&b[c[1]]){a.cssColor=b[c[1]]}else{a.cssColor=a.color}return a}function L(a){var b=l(a);b.fontWithFallbacks=y(b.family);return b}function M(a){return a.publicStaticsUrl+"/css/Helvetica/fontFace.css"}function N(b,d,e){var f={};a.forEach(d,function(a){f[a]=c.media.getMediaUrl(b,"user-site-fonts/v3/"+a+".css")});if(e==="WixSite"){f.helveticas=c.media.getMediaUrl(b,"user-site-fonts/v3/helvetica.css")}return f}function O(c,d){var e={};e.googleFonts=E(b,c,f);a.merge(e,N(d,f,c));return e}return{parseFontStr:l,parseStyleFont:J,getMetadata:n,getGoogleFontsUrl:r,getFontFamily:m,getFontFallback:o,getPageFontsMetaData:s,getFontFamilyWithFallbacks:y,getWixStoredFontsCssUrls:A,getWixStoredFontsCssUrlsWithParams:z,getCurrentSelectablefonts:C,getCurrentSelectablefontsWithParams:B,collectFontsFromTextDataArray:d.isOpen("fontsUpload")?undefined:c.fonts.fontsParser.collectFontsFromTextDataArray,getFontsUrl:F,getFontsUrlWithParams:E,getFontFamilyByStyleId:x,getFontClassName:I,registerCustomTextDataGetter:i,registerCustomFontFamiliesGetter:k,getPageUsedFontsList:t,getWixHelveticaUrl:M,getCssUrls:O,POSSIBLE_CHARACTERS_SETS:f}});define("fonts/utils/fontCss",["lodash","fonts/utils/fontUtils"],function(a,b){"use strict";function c(a){var c=a;var d=b.getFontFallback(a);if(d){c=c+","+d}c=c.replace(/[^,]*[^\w,\d\-][^,]*/g,function(a){return"'"+a.replace(/\+/g," ")+"'"});return c}function d(a,b){var c=a.match(/{color_(\d+)}/);if(!c){var d=a.match(/#[A-Z0-9]{3,6}/);if(d){return"color:"+d[0]+";"}return""}var e=c[1];var f=b[e];if(f.indexOf("#")===0){return"color:"+f+";"}return"color:rgba("+f+");"}function e(d){var e=d;if(a.includes(e,"#")){e=e.slice(0,e.indexOf("#"))}e=e.replace(/\{color_\d+\}/,"");var f=b.getFontFamily(e);var g=c(f);var h=e.replace(f,g);return h+";"}function f(b,c){if(a.startsWith(b,"font_")){var d=b.split("font_");if(d.length===2){return c.font[d[1]]}}return b}function g(b,c){c=!a.isArray(c)?c.color:c;var g=f(b);var h=e(g);var i=d(g,c);return h+i}function h(a,b){var c=f(a,b);return e(c)}function i(b,c){var d="";a.forEach(b,function(a,b){d+=".font_"+b+" {font: "+g(a,c)+"} \n"});return d}return{fontToCSSWithColor:g,fontToCSSWithoutColor:h,getThemeFontsCss:i,getFullFontFamily:c}});define("fonts/utils/fontsTracker",["lodash","fonts/utils/fontUtils"],function(a,b){"use strict";var c={permissions:"all",provider:"monotype"};var d=Object.create(null);function e(e,g){if(!a.isObject(e)){return false}d.masterPage=d.masterPage||f(e,"masterPage");d[g]=d[g]||f(e,g);var h=a.union(d.masterPage,d[g]);var i=b.getMetadata(h);return a.some(i,{permissions:c.permissions,provider:c.provider})}function f(a,c){return b.getPageUsedFontsList(a,c)}return{shouldTrackFonts:e}});define("fonts",["fonts/utils/fontUtils","fonts/utils/fontCss","fonts/utils/fontMetadata","fonts/utils/fontsTracker"],function(a,b,c,d){"use strict";return{fontUtils:a,fontCss:b,fontMetadata:c,fontsTracker:d}});